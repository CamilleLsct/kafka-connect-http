...
import static io.github.clescot.core.http.HttpPart.BodyType.FORM_DATA;
import static io.github.clescot.core.http.MediaType.*;
...
public class HttpPart implements Cloneable, Serializable {
    ...
    public HttpPart(byte[] contentAsByteArray) {
        this(Map.of(MediaType.KEY, Lists.newArrayList(APPLICATION_OCTET_STREAM)), contentAsByteArray);
    }
    ...
    public HttpPart(String fileName,File file) {
        this(Map.of(MediaType.KEY, Lists.newArrayList(APPLICATION_X_WWW_FORM_URLENCODED)),fileName,file);
    }
    ...
    public HttpPart(String fileName, URI fileUri) {
        this(Map.of(MediaType.KEY, Lists.newArrayList(APPLICATION_X_WWW_FORM_URLENCODED)),  fileName, fileUri);
    }
