...
/**
 * Interface to map a {@link SinkRecord} to an {@link HttpRequest}. Implementations should provide
 * the logic to determine if they can handle a specific record and how to map it.
 */
