...
public class HttpInMemoryQueueSourceConfigDefinition {
  ...
  public static final String SUCCESS_TOPIC_DOC =
      "Topic to receive successful http request/responses";
  public static final String ERROR_TOPIC = "error.topic";
  public static final String ERROR_TOPIC_DOC =
      "Topic to receive errors from http request/responses";
  public static final String CONTENT = "content";
  public static final String CONTENT_DOC =
      "either 'exchange' (HttpExchange) or 'response'(HttpResponse). default is 'exchange'.";
