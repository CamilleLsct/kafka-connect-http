...
public class HttpResponseSerdeFactory implements SerdeFactory<HttpResponse> {
  ...
  public HttpResponseSerdeFactory(
  ...
  public Serde<HttpResponse> buildSerde(boolean recordKey) {
    final KafkaJsonSchemaSerde<HttpResponse> jsonSchemaSerde =
        new KafkaJsonSchemaSerde<>(schemaRegistryClient, HttpResponse.class);
