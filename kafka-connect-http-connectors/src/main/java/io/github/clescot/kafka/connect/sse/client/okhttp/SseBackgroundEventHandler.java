 ...
 */
public class SseBackgroundEventHandler
    implements BackgroundEventHandler, ResponseClient<SseEvent, MessageEvent, SseEvent> {
  ...
  public SseEvent buildResponse(MessageEvent response) {
    return new SseEvent(response.getLastEventId(), response.getEventName(), response.getData());
  }
