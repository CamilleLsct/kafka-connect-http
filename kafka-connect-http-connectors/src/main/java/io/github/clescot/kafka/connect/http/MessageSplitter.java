...
/**
 * MessageSplitter is used to split a ConnectRecord based on a pattern. It uses JEXL expressions to
 * determine if a SinkRecord matches the splitter's criteria. If it matches, it splits the message
 * body according to the specified pattern and limit.
 */
