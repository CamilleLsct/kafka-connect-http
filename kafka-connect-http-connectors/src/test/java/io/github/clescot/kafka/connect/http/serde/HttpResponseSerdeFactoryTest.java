  ...
  class Constructor {
    ...
    void test_both_args_are_null() {
      Assertions.assertThrows(
          NullPointerException.class, () -> new HttpResponseSerdeFactory(null, null));
    }
    ...
    void test_schema_registry_client_is_null() {
      ...
      Assertions.assertThrows(
          NullPointerException.class, () -> new HttpResponseSerdeFactory(null, serdeConfig));
    }
    ...
    void test_serde_config_is_null() {
      try (MockSchemaRegistryClient schemaRegistryClient = new MockSchemaRegistryClient()) {
        Assertions.assertThrows(
            ...
            () -> new HttpResponseSerdeFactory(schemaRegistryClient, null));
      } catch (IOException e) {
