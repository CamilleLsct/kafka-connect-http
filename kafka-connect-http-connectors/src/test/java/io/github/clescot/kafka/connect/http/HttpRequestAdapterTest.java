...
class HttpRequestAdapterTest {
  ...
  void setup() throws RestClientException, IOException {
    ...
    jsonSchemaDeserializerConfig.put(
        KafkaJsonSchemaDeserializerConfig.JSON_VALUE_TYPE, HttpRequest.class.getName());
    ...
    deserializer =
        new KafkaJsonSchemaDeserializer<>(
            schemaRegistryClient, jsonSchemaDeserializerConfig, HttpRequest.class);
  }
  ...
  class TestConstructor {
    ...
    void test_with_empty_struct() {
      ...
      Assertions.assertThrows(
          NullPointerException.class, () -> HttpRequestAdapter.from(struct).toHttpRequest());
    }
    ...
    void test_with_struct_and_byte_array_nominal_case() {
      ...
      httpRequestStruct.put(
          BODY_AS_BYTE_ARRAY_FIELD,
          new String(DUMMY_BODY_AS_STRING.getBytes(StandardCharsets.UTF_8)));
      ...
      assertThat(httpRequest.getUrl()).isEqualTo(dummyUrl);
      assertThat(httpRequest.getMethod()).isEqualTo(dummyMethod);
      assertThat(httpRequest.getBodyAsByteArray())
          .isEqualTo(DUMMY_BODY_AS_STRING.getBytes(StandardCharsets.UTF_8));
    }
    ...
    void test_with_struct_and_parts_nominal_case() {
      ...
      assertThat(httpParts)
          .hasSameSizeAs(parts)
          .contains(
              Map.entry("part1", part1), Map.entry("part2", part2), Map.entry("part3", part3));
    }
  }
  ...
  class TestSerialization {
    ...
    void test_serialization() throws JsonProcessingException, JSONException {
      ...
      HttpRequest httpRequest = new HttpRequest("http://www.stuff.com", HttpRequest.Method.GET);
    ...
    void test_serialization_with_byte_array() throws JsonProcessingException, JSONException {
      ObjectMapper objectMapper = new ObjectMapper();
      objectMapper.registerModule(new JavaTimeModule());
      HttpRequest httpRequest = new HttpRequest("http://www.stuff.com", HttpRequest.Method.POST);
      Map<String, List<String>> headers = Maps.newHashMap();
      headers.put("X-correlation-id", Lists.newArrayList("sfds-55-77"));
      headers.put("X-request-id", Lists.newArrayList("aaaa-4466666-111"));
    ...
    void test_serialization_with_multipart() throws JsonProcessingException {
      ...
      objectMapper.registerModule(new JavaTimeModule());
      Map<String, List<String>> headers = Maps.newHashMap();
      headers.put("Content-Type", Lists.newArrayList("multipart/form-data; boundary=45789ee5"));
      // build httpRequest
      HttpRequest httpRequest =
          new HttpRequest(
              "http://www.stuff.com", HttpRequest.Method.POST, headers, BodyType.MULTIPART);
      ...
      String serializedHttpRequest = objectMapper.writeValueAsString(httpRequest);
      HttpRequest deserializedRequest =
          objectMapper.readValue(serializedHttpRequest, HttpRequest.class);
      assertThat(httpRequest).isEqualTo(deserializedRequest);
    }

    @Test
    void test_serialization_with_multipart_and_file()
    ...
    void test_deserialization() throws JsonProcessingException {
      ...
      HttpRequest expectedHttpRequest =
          new HttpRequest("http://www.stuff.com", HttpRequest.Method.GET);
      Map<String, List<String>> headers = Maps.newHashMap();
      headers.put("X-correlation-id", Lists.newArrayList("sfds-55-77"));
      headers.put("X-request-id", Lists.newArrayList("aaaa-4466666-111"));
      ...
      HttpRequest parsedHttpRequest =
          objectMapper.readValue(httpRequestAsString, HttpRequest.class);
    ...
    void test_deserialization_with_byte_array() throws JsonProcessingException {
      ...
      objectMapper.registerModule(new JavaTimeModule());
      HttpRequest expectedHttpRequest =
          new HttpRequest("http://www.stuff.com", HttpRequest.Method.POST);
    ...
    void test_serialize_and_deserialize_http_request_with_low_level_serializer() {
      ...
      jsonSchemaSerializerConfig.put(
          KafkaJsonSchemaSerializerConfig.ONEOF_FOR_NULLABLES, "" + useOneOfForNullables);
      jsonSchemaSerializerConfig.put(
          KafkaJsonSchemaSerializerConfig.FAIL_UNKNOWN_PROPERTIES, "" + failUnknownProperties);

      KafkaJsonSchemaSerializer<HttpRequest> mySerializer =
      ...
      jsonSchemaDeserializerConfig.put(
          KafkaJsonSchemaDeserializerConfig.SCHEMA_REGISTRY_URL_CONFIG, "mock://stuff.com");
      KafkaJsonSchemaDeserializer<HttpRequest> myDeserializer =
          new KafkaJsonSchemaDeserializer<>(
              schemaRegistryClient, jsonSchemaDeserializerConfig, HttpRequest.class);
    ...
    void test_serialize_and_deserialize_http_request_with_body_as_string() {
      ...
      jsonSchemaDeSerializerConfig.put(
          KafkaJsonSchemaDeserializerConfig.JSON_VALUE_TYPE, HttpRequest.class.getName());
      jsonSchemaDeSerializerConfig.put(
          KafkaJsonSchemaDeserializerConfig.FAIL_UNKNOWN_PROPERTIES, "" + failUnknownProperties);
      KafkaJsonSchemaDeserializer<HttpRequest> myDeserializer =
          new KafkaJsonSchemaDeserializer<>(
              schemaRegistryClient, jsonSchemaDeSerializerConfig, HttpRequest.class);
    ...
    void test_serialize_and_deserialize_http_request_with_body_as_string_with_converter() {
      ...
      byte[] fromConnectData =
          jsonSchemaConverter.fromConnectData(
              DUMMY_TOPIC,
              HttpRequestAdapter.SCHEMA,
              HttpRequestAdapter.from(httpRequest).toStruct());
      // like in kafka connect Sink connector, convert byte[] to struct
      SchemaAndValue schemaAndValue =
          jsonSchemaConverter.toConnectData(DUMMY_TOPIC, fromConnectData);
      // then
