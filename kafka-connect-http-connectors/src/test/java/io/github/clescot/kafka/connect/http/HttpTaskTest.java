...
public class HttpTaskTest {
  ...
  class Call {
    ...
    void test_nominal_case() throws ExecutionException, InterruptedException {
      ...
      HttpConnectorConfig httpConnectorConfig =
          new HttpConnectorConfig(httpConfigDefinition.config(), settings);
      io.github.clescot.client.http.HttpTask httpTask =
          new io.github.clescot.client.http.HttpTask(
      ...
      HttpRequest httpRequest =
          getDummyHttpRequest("http://" + IP + ":" + httpPort + "/ping1", "1");
    ...
    void test_two_calls() throws ExecutionException, InterruptedException {
      ...
      HttpConnectorConfig httpConnectorConfig =
          new HttpConnectorConfig(httpConfigDefinition.config(), settings);
      io.github.clescot.client.http.HttpTask<SinkRecord, OkHttpClient, okhttp3.Request, Response>
          httpTask =
              new io.github.clescot.client.http.HttpTask<>(
                  new OkHttpClientFactory(),
                  httpConnectorConfig.getList(REQUEST_GROUPER_IDS),
      ...
      String vuid = "2";
      HttpRequest httpRequest =
          getDummyHttpRequest("http://" + IP + ":" + httpPort + "/ping2", vuid);
      ...
      HttpRequest httpRequest2 =
          getDummyHttpRequest("http://" + IP + ":" + httpPort + "/ping3", vuid);
  ...
  private List<Cookie> getCookies(
      io.github.clescot.client.http.HttpTask httpTask, HttpRequest httpRequest) {
  ...
  class SelectionConfiguration {
    ...
    @Test
    void
        test_when_two_request_have_different_vu_id_then_two_different_configuration_instances_are_selected() {
      // given
      WireMockRuntimeInfo wmRuntimeInfo = wmHttp.getRuntimeInfo();
      ...
      HttpRequest httpRequest =
          getDummyHttpRequest("http://" + IP + ":" + wmRuntimeInfo.getHttpPort() + "/path2", "3");
