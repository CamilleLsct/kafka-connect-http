  ...
  class Constructor {
    ...
    void test_both_args_are_null() {
      Assertions.assertThrows(
          NullPointerException.class, () -> new HttpExchangeSerdeFactory(null, null));
    }
    ...
    void test_schema_registry_client_is_null() {
      ...
      Assertions.assertThrows(
          NullPointerException.class, () -> new HttpExchangeSerdeFactory(null, serdeConfig));
    }
    ...
    void test_serde_config_is_null() {
      try (MockSchemaRegistryClient schemaRegistryClient = new MockSchemaRegistryClient()) {
        Assertions.assertThrows(
            ...
            () -> new HttpExchangeSerdeFactory(schemaRegistryClient, null));
      } catch (IOException e) {
