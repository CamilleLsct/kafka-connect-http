...
class SseHttpClientConfigurationTest {
  ...
  @RegisterExtension static WireMockExtension wmHttp;
  ...
  void test_sse_client_connect() {
    ...
    SseConfiguration client =
        buildSseConfiguration(
            Configuration.DEFAULT_CONFIGURATION_ID,
            settings,
            service,
    ...
    assertThat(secondEvent.getData())
        .isEqualTo(
            """
