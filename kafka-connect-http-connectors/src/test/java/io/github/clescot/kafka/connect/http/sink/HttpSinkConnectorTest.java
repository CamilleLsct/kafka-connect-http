...
public class HttpSinkConnectorTest {
  ...
  class TestConfig {
    ...
    void test_with_default_configuration_and_custom_static_headers() {
      ...
      // then
      assertThat(configDef).isNotNull();
      assertThat(configDef.configKeys())
          .containsKey("config.default.enrich.request.static.header.header1");
    }
    ...
    void test_with_multiple_configurations_and_custom_static_headers() {
      ...
      assertThat(configDef.configKeys())
          .containsKey("config.default.enrich.request.static.header.header1");
      assertThat(configDef.configKeys())
          .containsKey("config.default.enrich.request.static.header.header2");
      assertThat(configDef.configKeys())
          .containsKey("config.config1.enrich.request.static.header.header3");
      assertThat(configDef.configKeys())
          .containsKey("config.config1.enrich.request.static.header.header4");
      assertThat(configDef.configKeys())
          .containsKey("config.config2.enrich.request.static.header.header5");
      assertThat(configDef.configKeys())
          .containsKey("config.config2.enrich.request.static.header.header6");
    }
  }
}
