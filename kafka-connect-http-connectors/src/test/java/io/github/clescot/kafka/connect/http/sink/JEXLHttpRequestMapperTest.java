...
class JEXLHttpRequestMapperTest {
  ...
  class Constructor {
    ...
    void test_empty_expression() {
      Assertions.assertThrows(
          ...
          () -> new JEXLHttpRequestMapper(DEFAULT, jexlEngine, "", "", null, null, null, null));
    }
      ...
      Assertions.assertThrows(
          ...
          () ->
              new JEXLHttpRequestMapper(
                  DEFAULT, jexlEngine, null, "'http://url.com'", null, null, null, null));
    }
  ...
  class Map {
    ...
    @Test
    void test_valid_expression_with_url_from_sink_record() {
      JEXLHttpRequestMapper jexlHttpRequestMapper =
          new JEXLHttpRequestMapper(
              DEFAULT,
              jexlEngine,
              "sinkRecord.topic()=='myTopic'",
      ...
      SinkRecord sinkRecord =
          new SinkRecord("test", 0, Schema.STRING_SCHEMA, "123", Schema.STRING_SCHEMA, url, 0);
    ...
    void test_valid_expression_with_url_method_and_body_from_sink_record() {
      ...
      SinkRecord mySinkRecord =
          new SinkRecord("test", 0, Schema.STRING_SCHEMA, "123", Schema.STRING_SCHEMA, value, 0);
      HttpRequest httpRequest = jexlHttpRequestMapper.map(mySinkRecord);
      assertThat(httpRequest.getUrl()).isEqualTo("http://test.com");
      assertThat(httpRequest.getMethod()).isEqualTo(HttpRequest.Method.POST);
