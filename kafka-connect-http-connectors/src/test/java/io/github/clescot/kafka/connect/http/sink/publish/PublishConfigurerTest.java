...
class PublishConfigurerTest {
  ...
  class ConfigureProducerPublishMode {
    ...
    void test_null_arg() {
      ...
      Assertions.assertThrows(
          ...
          () -> publishConfigurer.configureProducerPublishMode(null, kafkaProducer));
    }
    ...
    void test_empty_arg() {
      ...
      Assertions.assertThrows(
          ...
          () -> publishConfigurer.configureProducerPublishMode(httpConnectorConfig, kafkaProducer));
    }
    ...
    void test_only_bootstrap_servers() {
      ...
      PartitionInfo partitionInfo =
          new PartitionInfo("success", 0, node, new Node[] {}, new Node[] {});
      ...
      MockProducer<String, Object> mockProducer =
          new MockProducer<>(
              cluster, true, new RoundRobinPartitioner(), new StringSerializer(), null);
  ...
  class ConfigureInMemoryQueue {
    ...
    void test_null() {
      PublishConfigurer publishConfigurer = PublishConfigurer.build();
      Assertions.assertThrows(
          NullPointerException.class, () -> publishConfigurer.configureInMemoryQueue(null));
    }
    ...
    void test_empty_connector_config() {
      ...
      Assertions.assertDoesNotThrow(
          () -> publishConfigurer.configureInMemoryQueue(httpConnectorConfig));
    }
  }
}
