...
import io.github.clescot.client.http.config.AddSuccessStatusToHttpExchangeFunction;
import io.github.clescot.client.http.okhttp.OkHttpClient;
import io.github.clescot.client.http.ssl.AlwaysTrustManagerFactory;
...
public class HttpSinkTaskTest {
  ...
  public static final String BEARER_TOKEN =
      "Bearer BQDzs98uhifaGayk8H9tCTRozufhFmgV_HKMCnnDdMTdz1FcOo3sdj8OZJ_azo96LRdLI9_1uJOCXxbGZme11KCb6ZxTuCt8B5FxEeECb1kO_-UDuf8";
  public static final String BEARER_TOKEN_2 =
      "Bearer BQDzs98uhifaGayk8H9tCTRozufhFmgV_AAAAAAAAdz1FcOo3sdj8OZJ_BBBBBBBBBBB_1uJOCXxbGZme11KCb6ZxTuCt8B5FxEeECb1kO_-UDuf8";
  public static final String OK = "OK";

  @Mock ErrantRecordReporter errantRecordReporter;
  @Mock SinkTaskContext sinkTaskContext;

  @Mock Queue<HttpExchange> dummyQueue;

  @InjectMocks OkHttpSinkTask okHttpSinkTask;

  @InjectMocks AHCSinkTask ahcSinkTask;
    ...
    void test_start_without_settings_default_httprequestmapper_is_direct() {
      Assertions.assertDoesNotThrow(
          () -> {
            ...
            okHttpSinkTask.start(settings);
            assertThat(okHttpSinkTask.getDefaultHttpRequestMapper())
                .isInstanceOf(DirectHttpRequestMapper.class);
          });
    }
    ...
    void test_start_with_settings_httprequestmapper_is_direct() {
      Assertions.assertDoesNotThrow(
          () -> {
            ...
            assertThat(okHttpSinkTask.getDefaultHttpRequestMapper())
                .isInstanceOf(DirectHttpRequestMapper.class);
            DirectHttpRequestMapper httpRequestMapper =
                (DirectHttpRequestMapper) okHttpSinkTask.getDefaultHttpRequestMapper();
            assertThat(httpRequestMapper.getExpression().getSourceText())
                .isEqualTo(JEXL_ALWAYS_MATCHES);
          });
    }
    ...
    void test_start_with_settings_httprequestmapper_is_jexl() {
      Assertions.assertDoesNotThrow(
          () -> {
            HashMap<String, String> settings = Maps.newHashMap();
            settings.put(
                DEFAULT_REQUEST_MAPPER_PREFIX + REQUEST_MAPPER_DEFAULT_MODE,
                MapperMode.JEXL.name());
            settings.put(
                DEFAULT_REQUEST_MAPPER_PREFIX + REQUEST_MAPPER_DEFAULT_URL_EXPRESSION,
                "sinkRecord.value()");
            settings.put(
                DEFAULT_REQUEST_MAPPER_PREFIX + REQUEST_MAPPER_DEFAULT_METHOD_EXPRESSION, "'GET'");
            okHttpSinkTask.start(settings);
            assertThat(okHttpSinkTask.getDefaultHttpRequestMapper())
                .isInstanceOf(JEXLHttpRequestMapper.class);
            JEXLHttpRequestMapper httpRequestMapper =
                (JEXLHttpRequestMapper) okHttpSinkTask.getDefaultHttpRequestMapper();
            assertThat(httpRequestMapper.getJexlMatchingExpression().getSourceText())
                .isEqualTo("true");
            assertThat(httpRequestMapper.getJexlUrlExpression().getSourceText())
                .isEqualTo("sinkRecord.value()");
            assertThat(httpRequestMapper.getJexlMethodExpression().get().getSourceText())
                .isEqualTo("'GET'");
            assertThat(httpRequestMapper.getJexlBodyExpression()).isEmpty();
            assertThat(httpRequestMapper.getJexlBodyTypeExpression().get().getSourceText())
                .isEqualTo("'STRING'");
            assertThat(httpRequestMapper.getJexlBodyExpression()).isEmpty();
      ...
      Assertions.assertDoesNotThrow(
          () -> {
            ...
            settings.put(
                DEFAULT_REQUEST_MAPPER_PREFIX + REQUEST_MAPPER_DEFAULT_METHOD_EXPRESSION, "'GET'");
            settings.put(
                DEFAULT_REQUEST_MAPPER_PREFIX + REQUEST_MAPPER_DEFAULT_BODY_EXPRESSION,
                "'my request body'");
            settings.put(
                DEFAULT_REQUEST_MAPPER_PREFIX + REQUEST_MAPPER_DEFAULT_BODYTYPE_EXPRESSION,
                "'STRING'");
            settings.put(
                DEFAULT_REQUEST_MAPPER_PREFIX + REQUEST_MAPPER_DEFAULT_HEADERS_EXPRESSION,
                "{'test1':['value1','value2',...]}");
            okHttpSinkTask.start(settings);
            assertThat(okHttpSinkTask.getDefaultHttpRequestMapper())
                .isInstanceOf(JEXLHttpRequestMapper.class);
            ...
            assertThat(httpRequestMapper.getJexlMethodExpression().get().getSourceText())
                .isEqualTo("'GET'");
            assertThat(httpRequestMapper.getJexlBodyExpression().get().getSourceText())
                .isEqualTo("'my request body'");
            assertThat(httpRequestMapper.getJexlBodyTypeExpression().get().getSourceText())
                .isEqualTo("'STRING'");
            assertThat(httpRequestMapper.getJexlHeadersExpression().get().getSourceText())
                .isEqualTo("{'test1':['value1','value2',...]}");
          });
    }
  }
          ...
          () -> {
            ...
            when(httpClient.call(any(HttpRequest.class), any(AtomicInteger.class)))
                .thenReturn(
                    CompletableFuture.supplyAsync(
                        () -> getHttpExchange("https://toto.com", HttpRequest.Method.GET, 200)));
            when(httpClient.getEnrichRequestFunction()).thenReturn(request -> request);
            when(httpClient.customizeForUser(anyString())).thenReturn(httpClient);
            okHttpSinkTask.getDefaultConfiguration().setClient(httpClient);
            ...
            SinkRecord myRecord =
                new SinkRecord(
                    ...
                    "key",
                    Schema.STRING_SCHEMA,
                    getHttpRequestAsString("https://toto.com", HttpRequest.Method.GET),
                    0L);
          ...
          () -> {
            ...
            URL resource =
                Thread.currentThread()
                    ...
                    .getResource(CLIENT_TRUSTSTORE_JKS_FILENAME);
    ...
    void test_start_with_custom_trust_store_path_password_type_and_algorithm() {
      Assertions.assertDoesNotThrow(
          () -> {
            ...
            settings.put(
                CONFIG_HTTP_CLIENT_SSL_TRUSTSTORE_PASSWORD, CLIENT_TRUSTSTORE_JKS_PASSWORD);
  ...
  class Put {
    ...
    void test_put_with_no_records() {
      ...
      when(httpClient.call(any(HttpRequest.class), any(AtomicInteger.class)))
          .thenReturn(CompletableFuture.supplyAsync(() -> dummyHttpExchange));
      ahcSinkTask.getDefaultConfiguration().setClient(httpClient);
    ...
    void test_put_with_publish_to_in_memory_queue_without_consumer() {
      ...
      // when
      // then
      Assertions.assertThrows(IllegalArgumentException.class, () -> okHttpSinkTask.start(settings));
    }
    ...
    void test_put_with_publish_mode_set_to_producer() {
      ...
      Cluster cluster =
          new Cluster(
              "dummyClusterId", nodes, partitionInfos, Sets.newHashSet(), Sets.newHashSet());
      ...
      MockProducer<String, Object> mockProducer =
          new MockProducer<>(
              cluster, true, new RoundRobinPartitioner(), new StringSerializer(), jsonSerializer);
      ...
      when(httpClient.getEnrichRequestFunction()).thenReturn(request -> request);
      when(httpClient.customizeForUser(anyString())).thenReturn(httpClient);
      when(httpClient.getAddSuccessStatusToHttpExchangeFunction())
          .thenReturn(new AddSuccessStatusToHttpExchangeFunction(defaultSuccessPattern));
      myOkHttpSinkTask.getDefaultConfiguration().setClient(httpClient);
          ...
          () -> {
            ...
            SinkRecord sinkRecord1 =
                new SinkRecord(
                    ...
                    "key",
                    Schema.STRING_SCHEMA,
                    getLocalHttpRequestAsStringWithPath(
                        wmRuntimeInfo.getHttpPort(), "/path1", "POST", DUMMY_BODY),
                    -1,
                    System.currentTimeMillis(),
                    TimestampType.CREATE_TIME,
                    headers);
            ...
            SinkRecord sinkRecord2 =
                new SinkRecord(
                    ...
                    Schema.STRING_SCHEMA,
                    getLocalHttpRequestAsStringWithPath(
                        wmRuntimeInfo.getHttpPort(), "/path2", "POST", DUMMY_BODY),
                    -1,
                    System.currentTimeMillis(),
                    TimestampType.CREATE_TIME,
                    headers);
            ...
            SinkRecord sinkRecord3 =
                new SinkRecord(
                    ...
                    Schema.STRING_SCHEMA,
                    getLocalHttpRequestAsStringWithPath(
                        wmRuntimeInfo.getHttpPort(), "/path3", "POST", DUMMY_BODY),
                    -1,
                    System.currentTimeMillis(),
                    TimestampType.CREATE_TIME,
                    headers);
...
""";
            ...
            // then
            wireMock.verifyThat(
                postRequestedFor(urlEqualTo("/path1"))
          ...
          () -> {
            ...
            String nonMatchingValue =
                """
                        ...
                        """;
            SinkRecord nonMatchingSinkRecord =
                new SinkRecord(
                    "myTopic",
                    0,
                    Schema.STRING_SCHEMA,
            ...
            wireMock.verifyThat(
                postRequestedFor(urlEqualTo("/path1"))
                    .withRequestBody(equalTo("stuff1#stuff2#stuff3")));
            wireMock.verifyThat(
                postRequestedFor(urlEqualTo("/pathA")).withRequestBody(equalTo("stuffA")));
          });
    }
          ...
          () -> {
            ...
            String nonMatchingValue2 =
                """
                        ...
                        """;
            SinkRecord nonMatchingSinkRecord2 =
                new SinkRecord(
                    "myTopic",
                    0,
                    Schema.STRING_SCHEMA,
            ...
            wireMock.verifyThat(
                postRequestedFor(urlEqualTo("/path1"))
                    .withRequestBody(equalTo("stuff1#stuff2#stuff3")));
            wireMock.verifyThat(
                2, postRequestedFor(urlEqualTo("/pathA")).withRequestBody(equalTo("stuffA")));
          });
    }
    ...
    void test_request_grouper_with_message_limit() {
      Assertions.assertDoesNotThrow(
          () -> {
            ...
            // then
            wireMock.verifyThat(
                postRequestedFor(urlEqualTo("/path1")).withRequestBody(equalTo("stuff1stuff2")));
            wireMock.verifyThat(
                postRequestedFor(urlEqualTo("/path1")).withRequestBody(equalTo("stuff3")));
          });
    }
    ...
    void test_request_grouper_with_body_limit() {
      Assertions.assertDoesNotThrow(
          () -> {
            ...
            wireMock.verifyThat(
                postRequestedFor(urlEqualTo("/path1")).withRequestBody(equalTo("1234567890")));
          });
    }
    ...
    void test_meter_registry_activate_jmx() {
      Assertions.assertDoesNotThrow(
          () -> {
            ...
            List<MeterRegistry> meterRegistryList =
                Arrays.asList(registries.toArray(new MeterRegistry[0]));
    ...
    void test_meter_registry_activate_jmx_and_prometheus() {
      Assertions.assertDoesNotThrow(
          () -> {
            ...
            MeterRegistry meterRegistry1 = meterRegistryList.get(0);
            assertThat(
                JmxMeterRegistry.class.isAssignableFrom(meterRegistry1.getClass())
                    || PrometheusMeterRegistry.class.isAssignableFrom(meterRegistry1.getClass()));
            MeterRegistry meterRegistry2 = meterRegistryList.get(1);
            assertThat(
                PrometheusMeterRegistry.class.isAssignableFrom(meterRegistry2.getClass())
                    || JmxMeterRegistry.class.isAssignableFrom(meterRegistry2.getClass()));
            List<Meter> meters = meterRegistry1.getMeters();
            assertThat(meters).isNotEmpty();
            for (Meter meter : meters) {
              LOGGER.info("meter : {}", meter.getId());
  ...
  class PutWithLatencies {
    @Test
    @DisplayName(
        "test with multiple http requests with slow responses with AHC implementation, expected ok")
    ...
    @Test
    @DisplayName(
        "test with multiple http requests with slow responses with OKHttp implementation, expected ok")
    ...
    @Test
    @DisplayName(
        "test with multiple http requests with slow responses with AHC implementation with fixed thread pool, expected ok")
    ...
    @Test
    @DisplayName(
        "test with multiple http requests with slow responses with OKHttp implementation and fixed thread pool, expected ok")
  ...
  class PutWithAuthentication {
    ...
    @Test
    void test_oauth2_authentication_client_credentials_flow_with_basic_auth_to_get_token()
        throws IOException {
      // given
      ...
      Map<String, String> settings = Maps.newHashMap();
      settings.put(
          CONFIG_DEFAULT_HTTP_CLIENT_AUTHENTICATION_OAUTH2_CLIENT_CREDENTIALS_FLOW_ACTIVATE,
          "true");
      settings.put(
          CONFIG_DEFAULT_HTTP_CLIENT_AUTHENTICATION_OAUTH2_CLIENT_CREDENTIALS_FLOW_WELL_KNOWN_URL,
          httpBaseUrl + "/.well-known/openid-configuration");
      settings.put(
          CONFIG_DEFAULT_HTTP_CLIENT_AUTHENTICATION_OAUTH2_CLIENT_CREDENTIALS_FLOW_CLIENT_ID,
          "44d34a4d05344c97837d463207805f8b");
      settings.put(
          CONFIG_DEFAULT_HTTP_CLIENT_AUTHENTICATION_OAUTH2_CLIENT_CREDENTIALS_FLOW_CLIENT_SECRET,
          "3fc0576720544ac293a3a5304e6c0fa8");
      ...
      SinkRecord sinkRecord1 =
          new SinkRecord(
              ...
              Schema.STRING_SCHEMA,
              getLocalHttpRequestAsStringWithPath(
                  wmRuntimeInfo.getHttpPort(), SONG_PATH, "GET", null),
              -1,
              System.currentTimeMillis(),
              TimestampType.CREATE_TIME,
              headers);
      ...
      String scenario =
          "test_oauth2_authentication_client_credentials_flow_with_basic_auth_to_get_token";
      // good well known content
      wireMock.register(
          WireMock.get(WELL_KNOWN_OPENID_CONFIGURATION)
              .inScenario(scenario)
      ...
      wireMock.register(
          WireMock.post("/api/token")
              .inScenario(scenario)
              .withHeader(
                  "Content-Type", containing("application/x-www-form-urlencoded; charset=UTF-8"))
              .withHeader(
                  "Authorization",
                  containing(
                      "Basic NDRkMzRhNGQwNTM0NGM5NzgzN2Q0NjMyMDc4MDVmOGI6M2ZjMDU3NjcyMDU0NGFjMjkzYTNhNTMwNGU2YzBmYTg="))
              .whenScenarioStateIs(UNAUTHORIZED)
              .willReturn(
                  WireMock.aResponse().withStatus(200).withStatusMessage(OK).withBody(tokenContent))
      ...
      wireMock.register(
          WireMock.get(SONG_PATH)
              ...
              .willReturn(
                  WireMock.aResponse().withStatus(200).withStatusMessage(OK).withBody(songContent))
          ...
          WireMock.get(SONG_PATH)
              ...
              .willReturn(
                  WireMock.aResponse()
                      .withStatus(401)
                      .withStatusMessage(
                          "Unauthorized") // 401 + 'WWW-Authenticate' trigger challenge
      ...
      wireMock.verifyThat(
          3,
          getRequestedFor(urlEqualTo(SONG_PATH))
              .withHeader("Authorization", equalTo(BEARER_TOKEN)));
    }

    @Test
    void
        test_oauth2_authentication_client_credentials_flow_with_basic_auth_to_get_token_and_expiration()
            throws IOException {
      // given
      final String WELL_KNOWN_OPENID_CONFIGURATION = "/.well-known/openid-configuration";
      final String WELL_KNOWN_OK = "WellKnownOk";
      ...
      wireMock.verifyThat(
          1,
          getRequestedFor(urlEqualTo(SONG_PATH))
              .withHeader("Authorization", equalTo(BEARER_TOKEN_2)));
    }
  }
  ...
  private String getLocalHttpRequestAsStringWithPath(
      int port, String path, String method, String dummyBody) {
    return "{\n"
        + "  \"url\": \""
        + "http://localhost:"
        + port
