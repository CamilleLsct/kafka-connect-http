...
public interface RequestResponseClient<R extends Request, NR, S extends Response, NS, E extends Exchange<R,S>> extends RequestClient<R, NR,E>, io.github.clescot.client.ResponseClient<S, NS,E> {
